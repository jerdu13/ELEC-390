...
walking_data_3 = pd.read_csv('jeremys-dataset/jeremy-walking-combined.csv')
walking_data = pd.concat([walking_data_1, walking_data_2,walking_data_3], ignore_index=True)
...
jump_data_3 = pd.read_csv('jeremys-dataset/jeremy-jumping-combined.csv')
jump_data = pd.concat([jump_data_1, jump_data_2,jump_data_3], ignore_index=True)
