...
filenames = ['Louie\'s-Dataset/combined_walking.csv', 'Louie\'s-Dataset/combined-jumping.csv', 'ryans-dataset/walking-data/walking-combined.csv','ryans-dataset/jumping-data/jumping-combined.csv']
